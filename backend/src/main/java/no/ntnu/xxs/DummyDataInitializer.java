...
public class DummyDataInitializer implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        ...
        User adminUser = new User("Adam", "Jensen", "adam@gmail.com", "$2a$10$2v2cawu29cb35WJKxVajBeNE2sXC0AD95.LWAjT5CpHfGgEULyF1m", "Norway", "1302", "Langehus", "Grensegata 89");
        User carl = new User("Carl", "Hansen", "carl@gmail.com", "$2a$10$F1oGKj9Cw3T78qzChXsaTuYX90/MWu5XkknWDbpwglwry9Bh2h9OK", "Norway", "1884", "Trondheim", "Kongens gate 12");
