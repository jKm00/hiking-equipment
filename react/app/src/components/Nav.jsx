      ...
      <div className="second__nav">
        <ul className="second__nav__links">
          <li className="second__nav__item">
            <a href="shop-men" className="second__nav__link">
              Men
            </a>
          </li>
          <li className="second__nav__item">
            <a href="shop-women" className="second__nav__link">
              Women
            </a>
          </li>
          <li className="second__nav__item">
            <a href="" className="second__nav__link">
              Animal
            </a>
          </li>
        </ul>
