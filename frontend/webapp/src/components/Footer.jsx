    ...
    <footer className="footer">
      <div className="first-footer">
        ...
        <ul className="socials">
          <li className="socials__item">
            <a href="https://www.instagram.com/chucknorris/" className="socials__link" target="_blank">
          ...
          <li className="socials__item">
            <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" className="socials__link" target="_blank">
          ...
          <li className="socials__item">
            <a href="https://mobile.twitter.com/yilong_musk" className="socials__link" target="_blank">
          ...
          <li className="socials__item">
            <a href="https://www.facebook.com/profile.php?id=100057220615965" className="socials__link" target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <ul className="footer-list footer-list--link">
          ...
          <li className="footer-list__item">
            <Link to="/shop/all#shop-header" className="footer-list__link">
              Go to shop
            </Link>
          </li>
          <li className="footer-list__item">
        ...
        <ul className="footer-list footer-list--contact-info">
          ...
          <li className="footer-list__item">
            ...
            <a href="tel:463-87-526" className="footer-list__link">
              (+47) 463 87 526
            </a>
          </li>
          <li className="footer-list__item">
            ...
            <a href="mailto:xxs@gmail.com" className="footer-list__link">
              xxs@gmail.com
            </a>
          </li>
        </ul>
      ...
      <div className="second-footer">
        <div className="second-footer--wrapper">
          ...
          <p className="second-footer__legal">
